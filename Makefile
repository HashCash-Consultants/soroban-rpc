...
GOLDFLAGS :=	-X 'github.com/HashCash-Consultants/soroban-rpc/cmd/soroban-rpc/internal/config.Version=${REPOSITORY_VERSION}' \
				-X 'github.com/HashCash-Consultants/soroban-rpc/cmd/soroban-rpc/internal/config.CommitHash=${REPOSITORY_COMMIT_HASH}' \
				-X 'github.com/HashCash-Consultants/soroban-rpc/cmd/soroban-rpc/internal/config.BuildTimestamp=${BUILD_TIMESTAMP}' \
				-X 'github.com/HashCash-Consultants/soroban-rpc/cmd/soroban-rpc/internal/config.Branch=${REPOSITORY_BRANCH}'
...
# https://github.com/HashCash-Consultants/pipelines/hcnet-aurora/Jenkinsfile-soroban-rpc-package-builder
